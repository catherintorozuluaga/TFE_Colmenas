/*  Tansmisor Abejas con Aguijon Nodo 2
...
#define RST 23
#define DIO0 26
const int nodeid=2; // Tansmisor 2 - Abejas CON aguijon
String dataLoRa;
...
////////////////////////////////////////////////////////////////////
      ...
      if (bmi160.softReset() != BMI160_OK) {
          Serial.println("No se detecta BMI160 -Acelerometro");
          while (1);
        }
...
void loop() {
 ...
 ////////////////////////////////////////////////////////////
  // Envío de Datos LORA
  ////////////////////////////////////////////////////////////
  dataLoRa=String(nodeid)+','+String(Temperatura)+','+String(Humedad)+','+String(ax)+','+String(ay)+','+String(az)+','+String(f)+','+String(ppm);
